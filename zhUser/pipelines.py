            ...
            if not recordTimestamp or (int(currentTimestamp)-int(recordTimestamp) > int(settings.INFO_UPDATE_PERIOD)):        # the latest record time in hbase
                ...
                user_detail_dict={
                    ...
                    'user_link_id':str(item['userLinkId']),
                               ...
                               'user_location_name': item['userLocationText'],
                               ...
                               'user_business_topic_name': item['userBusinessText'],
                               ...
                               'user_employment_topic_name': item['userEmploymentText'],
                               ...
                               'user_position_topic_name': item['userPositionText'],
                               ...
                               'user_education_topic_name': item['userEducationText'],
                               ...
                               'user_education_extra_topic_name': item['userEducationExtraText'],

                               'user_description_text':item['userDescriptionText'],
